...
<<<<<<< HEAD:Sources/ExyteChat/ChatView/Attachments/FullscreenMediaPages.swift
                        .onChange(of: viewModel.index) { newValue, _ in
=======
                        .onChange(of: viewModel.index) { _, newValue in
>>>>>>> upstream/main:Sources/ExyteChat/Views/Attachments/FullscreenMediaPages.swift
                            withAnimation {
